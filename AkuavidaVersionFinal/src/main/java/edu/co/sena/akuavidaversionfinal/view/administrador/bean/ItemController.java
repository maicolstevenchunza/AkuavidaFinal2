...
import edu.co.sena.akuavidaversionfinal.controlller.administrador.beans.ItemFacade;
...
public class ItemController implements Serializable {
    ...
    @EJB
    private edu.co.sena.akuavidaversionfinal.controlller.administrador.beans.ItemFacade ejbFacade;
    ...
    protected void setEmbeddableKeys() {
        selected.getItemPK().setPedidoFacturaIDFactura(selected.getPedido().getFacturaIDFactura());
        selected.getItemPK().setProductoIDproducto(selected.getProducto().getIDproducto());
    }

    protected void initializeEmbeddableKey() {
        selected.setItemPK(new edu.co.sena.akuavidaversionfinal.model.entities.ItemPK());
    }
    ...
    public Item getItem(edu.co.sena.akuavidaversionfinal.model.entities.ItemPK id) {
    ...
    public static class ItemControllerConverter implements Converter {
        ...
        edu.co.sena.akuavidaversionfinal.model.entities.ItemPK getKey(String value) {
            edu.co.sena.akuavidaversionfinal.model.entities.ItemPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.akuavidaversionfinal.model.entities.ItemPK();
            key.setProductoIDproducto(values[0]);
            key.setPedidoFacturaIDFactura(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(edu.co.sena.akuavidaversionfinal.model.entities.ItemPK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getProductoIDproducto());
            sb.append(SEPARATOR);
            sb.append(value.getPedidoFacturaIDFactura());
            return sb.toString();
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Item) {
                Item o = (Item) object;
                return getStringKey(o.getItemPK());
            } else {
